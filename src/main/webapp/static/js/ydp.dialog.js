...
ygDialog.fn = ygDialog.prototype = {
	...
	loading:function(){
		...
		loadDiv.html('<img src="'+YouGou.Base.domain+'/static/images/loading.gif"> 处理中，请稍候...');
...
** 载入css
**/
if ($("link[href*='ydp.dialog.css']").length == 0){
 var baseUrl=YouGou.Base.domain;
 if(typeof cdnUrl!="undefined"){
	 baseUrl=cdnUrl;
 }
 var strHref = $('link').eq(0).attr('href');
 var ver=strHref.split('?').pop();
 var css_href =baseUrl+'/static/css/ydp.dialog.css?'+ver;
...
+'<div class="uiDiv">'
+'<table class="uiTable"><tbody><tr><td><div class="clearfix dg_title"><h3 class="uiTitle">&nbsp;</h3><a class="uiClose" href="javascript:;">&nbsp;</a></div></td></tr><tr><td><div class="dg_content"><p class="dg_loading"><image src="'+YouGou.Base.domain+'/static/images/loading16.gif" /></p></div></td></tr></tbody></table></div></div>';
 ...
 * 封装有倒计时的对话框
 ******************************************************************************/
var commonDialog = null, dialog_timer;

function isFunction(o) {
    return Object.prototype.toString.call(o) == '[object Function]';
}
//显示对话框
function showCommonDialog(result, message,callback) {
	isYgDailogExist = false;
	commonDialog = new ygDialog({
	...
	if (result) {
		...
		img = 'warn_mid_icon.jpg';
	}
	commonDialog
			.content('<div><p style="margin-left:70px;margin-top:20px;"><img style="width:33px;height:33px;" src="/static/images/'
					+ img
					+ '"><em style="margin-left:10px;font-size:14px;font-weight:bold;">'
					+ message
					+ '</em></p><p style="margin-left:113px;margin-top:10px;"><em id="bind_tip" style="color: #AAA;">倒计时10秒后自动关闭</em></p><p style="margin-left:113px;margin-top:15px;"><a style="background: none repeat scroll 0% 0% #FF5001;border: 1px solid #F14E04;color: #FFF;padding:3px 12px 3px 19px;display: inline-block;width:35px;border-radius: 3px;vertical-align: middle;" href="javascript:void(0)" id="close_bind">确认</a></p></div>');
	$("#close_bind").click(function(){
		commonDialog.close();
	});
	var i = 5;
	var fn = function() {
